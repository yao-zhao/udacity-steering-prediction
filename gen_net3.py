...
def net(n):
    ...
    n.add_conv(24, kernel_size=5, stride=2, pad=0, bias_term=False)
    n.add_batchnorm()
    n.add_relu()
    n.add_conv(36, kernel_size=5, stride=2, pad=0, bias_term=False)
    n.add_batchnorm()
    n.add_relu()
    n.add_conv(48, kernel_size=5, stride=2, pad=0, bias_term=False)
    n.add_batchnorm()
    n.add_relu()
    n.add_conv(64, kernel_size=3, stride=1, pad=0, bias_term=False)
    n.add_batchnorm()
    n.add_relu()
    n.add_conv(64, kernel_size=3, stride=1, pad=0, bias_term=False)
    n.add_batchnorm()
...
net = b.BuildNet(net, name = 'net3', caffe_path = caffe_path)
net.save()